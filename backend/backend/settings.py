...
SECRET_KEY = "django-insecure-li7d9jcj4d(f1&alq#dj%2tqxabjr@p57!ab=w9$n(%)_2g2_*"
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('DB_HOST', 'localhost'), # CHANGE
...
# Go through each of these till a user is returned
